...
public class ProductServiceImpl implements ProductService {
    ...
    public Product getProductByName(String productName) throws IOException {
        ...
        Request requestForExternalApi = new Request.Builder().url("https://api.calorieninjas.com/v1/nutrition?query=" + productName).addHeader("X-Api-Key", "3tTSiLRQSqH+KhOWyc1zaA==TkIDRKtbqKj4Aryy").build();
    ...
    public List<Product> getProductByQuery(String query) throws IOException {
        OkHttpClient client = new OkHttpClient();
        Request requestForExternalApi = new Request.Builder().url("https://api.calorieninjas.com/v1/nutrition?query=" + query).addHeader("X-Api-Key", "3tTSiLRQSqH+KhOWyc1zaA==TkIDRKtbqKj4Aryy").build();
        Response responseFromExternalApi = client.newCall(requestForExternalApi).execute();
        ObjectMapper mapper = new ObjectMapper();
